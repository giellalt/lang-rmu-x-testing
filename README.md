...
[![Maturity](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgiellalt%2Flang-rmu-x-testing%2Fmain%2Fdocs%2Fbadgedata%2Ffst-maturity.json)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgiellalt%2Flang-rmu-x-testing%2Fmain%2Fdocs%2Fbadgedata%2Ffst-lemmacount.json)
...
[![Build Status](https://builds.giellalt.org/api/badge/lang-rmu-x-testing?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-rmu-x-testing/builds/latest)
...
[LICENSE](https://github.com/giellalt/lang-rmu/blob/main/LICENSE). The
authors named in the AUTHORS file are available to grant other licencing
choices.

Install proofing tools and [keyboards](https://github.com/giellalt/keyboard-rmu)
for the Tavringer Romani language by using the [Divvun Installer](http://divvun.no)
...
- [Language specific documentation](https://giellalt.github.io/lang-rmu/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Tavringer Romani language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/lang-rmu
```

Using Subversion:
```
svn checkout https://github.com/giellalt/lang-rmu.git/trunk lang-rmu
```

Building and installation
-------------------------

[INSTALL](https://github.com/giellalt/lang-rmu/blob/main/INSTALL)
