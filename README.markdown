...
This directory contains source files for the Tavringer Romani language
...
-   <https://giellalt.uit.no/lang/rmu/index.html> (analyser)
...
The Tavringer Romani language sources can be acquired using [giella SVN
